...
const Dashboard = () => {
  ...
  return (
    <Container className="dashboard-container">
      <h2 className="mb-4">Bem-vindo, [Nome do Usuário]</h2>

      <Row>
        <Card className="dashboard-card" onClick={() => handleNavigation('/perfil')}>
            <Card.Body>
              <Card.Title>Perfil</Card.Title>
              <Card.Text>Veja suas informações pessoais e histórico.</Card.Text>
            </Card.Body>
          </Card>
      </Row>
      ...
      <Row>
          <Card className="dashboard-card" onClick={() => handleNavigation('/meus-anuncios')}>
            <Card.Body>
